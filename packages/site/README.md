# microviz documentation site

> Documentation site for the microviz monorepo.
...
This site documents the microviz project and its packages:
- `@microviz/core`
- `@microviz/renderers`
- `@microviz/elements`
- `@microviz/themes`
- `@microviz/themes-tailwind`
