...
export class MicrovizSegmentedPill extends HTMLElement {
  ...
  #computeFromAttributes(): RenderModel {
    ...
    const separatorStroke = this.getAttribute("separator-stroke") ?? undefined;
    const separatorStrokeWidth = parseOptionalNumber(
      this.getAttribute("separator-stroke-width"),
    );
    const separatorStrokeOpacity = parseOptionalNumber(
      this.getAttribute("separator-stroke-opacity"),
    );
