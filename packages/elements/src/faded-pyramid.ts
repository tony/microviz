...
const SPEC_TYPE = "faded-pyramid";

export class MicrovizFadedPyramid extends HTMLElement {
  ...
  #computeFromAttributes(): RenderModel {
    ...
    const heightDecrement = this.hasAttribute("height-decrement")
      ? parseNumber(this.getAttribute("height-decrement"), 15)
      : undefined;
    ...
    return computeModel({
      data: segments,
      size: { height, width },
      spec: { gap, heightDecrement, minHeightPct, pad, type: SPEC_TYPE },
    });
  }
}
