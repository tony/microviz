...
const baseClasses =
  "flex select-none items-center justify-center bg-gradient-to-r from-indigo-500 to-purple-500 font-bold text-white transition-all hover:from-indigo-600 hover:to-purple-600 active:scale-95 dark:from-indigo-400 dark:to-purple-400";
